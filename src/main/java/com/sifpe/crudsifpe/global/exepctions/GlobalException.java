...
import com.sifpe.crudsifpe.global.utils.Operations;
...
public class GlobalException {
    ...
    public ResponseEntity<MessageDto> throwNotFoundException(ResourseNotFundException e) {
    ...
    public ResponseEntity<MessageDto> validationException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.badRequest()
                .body(new MessageDto(HttpStatus.BAD_REQUEST, Operations.trimBrakets(messages.toString())));
    }
}
